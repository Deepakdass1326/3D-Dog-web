...
function App() {
  return (
      ...
      <main>
        ...
        <section id="section-3">
          <div className="top">
            <div className="left">
              <h3>
                We're Carfting emotional <br /> experiances aimed <br /> at
    ...
    <span className="city active">Chicago<span className="dot">.</span></span>
    <span className="city">Amsterdam<span className="dot">.</span></span>
    <span className="city">Paris<span className="dot">.</span></span>
  </div>
        </section>
      </main>
    </>
